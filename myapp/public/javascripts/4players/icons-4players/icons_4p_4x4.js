            ...
            pair_target_2.innerHTML = `${pair_2}`;
              ...
              if (flip_cards[0].innerHTML === flip_cards[1].innerHTML && color_call_3.style.backgroundColor === "orange") {
                ...
                pair_target_3.innerHTML = `${pair_3}`;
                  ...
                  if (flip_cards[0].innerHTML === flip_cards[1].innerHTML && color_call_4.style.backgroundColor === "orange") {
                    pair_4 ++;
                    pair_target_4.innerHTML = `${pair_4}`;
                      ...
                      } else if (flip_cards[0].innerHTML !== flip_cards[1].innerHTML && color_call_4.style.backgroundColor === "orange") {
